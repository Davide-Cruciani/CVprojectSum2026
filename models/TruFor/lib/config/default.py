...
TRUFOR_ROOT = Path("../models/TruFor").resolve()
...
def update_config(cfg, args):
    ...
    cfg.merge_from_file(str(TRUFOR_ROOT / f'lib/config/{args.experiment}.yaml'))
    if cfg.TEST.MODEL_FILE == '':
        cfg.merge_from_list([
            'TEST.MODEL_FILE', 
            str(TRUFOR_ROOT/f'weights/{args.experiment}/best.pth.tar')
        ])
    try:
